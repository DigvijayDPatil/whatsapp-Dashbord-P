"""
Django settings for waba_dashboard project.
...
ROOT_URLCONF = 'waba_dashboard.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'api.context_processors.impersonation_context',
            ],
        },
    },
]

WSGI_APPLICATION = 'waba_dashboard.wsgi.application'
